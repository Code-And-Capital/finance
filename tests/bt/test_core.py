...
from bt.core import Node
from bt.core.security import (
    SecurityBase,
    FixedIncomeSecurity,
...
def test_update_fails_if_price_is_nan_and_position_open():
    ...
    try:
        ...
        assert str(e).startswith("Open position")
...
def test_strategy_combined_universe_regression():
    ...
    tests = [
        Backtest(child_strategy1, data),
        Backtest(child_strategy2, data),
    ]
    ...
    test = Backtest(parent_strategy, data)
    result = bt.run(test)
